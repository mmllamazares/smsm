...
const Notification = (fail: FailDetected) => {
  ...
  return (
    <div className='box-border flex flex-col border-2 shadow-md m-4 px-4 py-2 border-blanco rounded h-auto font-Roboto-Regular text-white cursor-pointer select-none' onClick={(e) => {
      e.stopPropagation()
      ...
      <div className="flex justify-between items-center w-full">
        ...
        <div className="flex justify-between items-center w-1/5">
          ...
          <button className='flex justify-center items-center place-content-end bg-red-500 hover:bg-white rounded w-6 h-6 text-blanco hover:text-red-500' onClick={e => {
            e.stopPropagation()
          }}><MdClose /></button>
        </div>
      </div>
      {
        ...
        showDetails && <div className="p-3 w-full h-full">
          ...
          <div className="flex justify-between pt-2">
            ...
            <button className="flex justify-center items-center hover:bg-primary-blue rounded w-6 h-6 duration-200" onClick={e => {
              e.stopPropagation()
            }}><MdLocationOn /></button>
          </div>
          <p>Causa: {cause}</p>
