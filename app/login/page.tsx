        ...
        <form className="max-w-sm mx-auto font-Roboto-Regular">
          <div className="mb-5">
            ...
            <input
              type="email"
              id="email"
              className="bg-gray-50 border border-secondary-light-blue text-gray-900 text-sm  focus:ring-primary-blue focus:border-primary-blue block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-blue dark:focus:border-primary-blue"
              required
            />
          </div>
          <div className="mb-5">
          ...
          <div className="flex items-start mb-5">
            <div className="flex items-center h-5">
              <input
                ...
                type="checkbox"
                value=""
                className="w-4 h-4 border border-secondary-light-blue bg-gray-50 focus:ring-3 focus:ring-primary-blue checked:bg-primary-blue dark:bg-gray-700 dark:border-gris dark:focus:ring-primary-blue dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800"
                required
              />
            </div>
            <label
